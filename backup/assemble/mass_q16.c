...
void mass_q16(int node_num, int element_num, int element_order,  int *element_node, double **node_xy, double **mass)

 /* mass_q16 computes the mass matrix, using 16-node rectangular, 36 ponits quadrature rule.
