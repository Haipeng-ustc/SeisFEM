...
void mass_t3(int node_num, int element_num, int element_order,  int *element_node, double **node_xy, double **mass)

 /* mass_t3 co mputes the mass matrix, using 3-node triangles, 3 ponits quadrature rule.
