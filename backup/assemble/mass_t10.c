...
void mass_t10(int node_num, int element_num, int element_order,  int *element_node, double **node_xy, double **mass)
/* mass_t10 computes the mass matrix, using 10-node triangles, 12 ponits quadrature rule.
