...
void mass_q4(int node_num, int element_num, int element_order,  int *element_node, double **node_xy, double **mass)

 /* mass_q4 computes the mass matrix, using 4-node rectangular, 36 ponits quadrature rule.
