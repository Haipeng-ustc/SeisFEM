...
void stiffness_sparse_t10(int node_num, int element_num, int element_order,  int *element_node, double **node_xy, int *stiffi, int *stiffj, double *stiffness, int stif_type)
