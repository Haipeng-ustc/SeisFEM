void elastic_mpml(char *type, int node_num, int element_num, int element_order, int *element_node, double **node_xy, int nnz, int csr_p_size, int step, double dt,
                  double f0, double t0, double edge_size, double xmin, double xmax, double ymin, double ymax, int pml_nx, int pml_ny, int src_num, int *src_node, int rec_num, int *rec_node, char *solver)
{
    ...
    *****************************************************************************/
    ...
    for (shot = 0; shot < src_num; shot++)
    {
        ...
        sprintf(filename_wavefield_u, "wavefield_u_shot_%d.dat", shot + 1);
        sprintf(filename_wavefield_w, "wavefield_w_shot_%d.dat", shot + 1);
        sprintf(filename_energy_u, "energy_u_shot_%d.dat", shot + 1);
        sprintf(filename_energy_w, "energy_w_shot_%d.dat", shot + 1);
        sprintf(filename_seismogram_u, "seismogram_u_shot_%d.dat", shot + 1);
        sprintf(filename_seismogram_w, "seismogram_w_shot_%d.dat", shot + 1);
